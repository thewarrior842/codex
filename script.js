...
const backAuth = document.getElementById("backAuth");
...
toggleAuthMode.addEventListener("click", function() {
    ...
    if (isLoginMode) {
        ...
        toggleAuthMode.innerHTML = "Don't have an account? <strong>Create one</strong>";
    } else {
        authTitle.textContent = "Create Account";
        toggleAuthMode.innerHTML = "Already have an account? <strong>Sign in</strong>";
    }
});
...
// Handle Back Buttons for new screens
backAuth.addEventListener("click", function() {
    goBack();
});
...
getStarted.addEventListener("click", function () {
    showScreen(authScreen); // Changed from dashboardScreen
});
